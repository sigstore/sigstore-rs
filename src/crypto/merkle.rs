...
mod tests {
    ...
    fn test_verify_consistency_empty_proof_non_trivial() {
        ...
        assert!(
            result
                .unwrap_err()
                .to_string()
                .contains("proof cannot be empty")
        );
    }
    ...
    const ROOTS: [[u8; 32]; 8] = [
        ...
        [
            0xfa, 0xc5, 0x42, 0x03, 0xe7, 0xcc, 0x69, 0x6c, 0xf0, 0xdf, 0xcb, 0x42, 0xc9, 0x2a,
            0x1d, 0x9d, 0xba, 0xf7, 0x0a, 0xd9, 0xe6, 0x21, 0xf4, 0xbd, 0x8d, 0x98, 0x66, 0x2f,
            0x00, 0xe3, 0xc1, 0x25,
        ],
        // Root for tree with 3 leaves
        [
            0xae, 0xb6, 0xbc, 0xfe, 0x27, 0x4b, 0x70, 0xa1, 0x4f, 0xb0, 0x67, 0xa5, 0xe5, 0x57,
            0x82, 0x64, 0xdb, 0x0f, 0xa9, 0xb5, 0x1a, 0xf5, 0xe0, 0xba, 0x15, 0x91, 0x58, 0xf3,
            0x29, 0xe0, 0x6e, 0x77,
        ],
        // Root for tree with 4 leaves
        [
            0xd3, 0x7e, 0xe4, 0x18, 0x97, 0x6d, 0xd9, 0x57, 0x53, 0xc1, 0xc7, 0x38, 0x62, 0xb9,
            0x39, 0x8f, 0xa2, 0xa2, 0xcf, 0x9b, 0x4f, 0xf0, 0xfd, 0xfe, 0x8b, 0x30, 0xcd, 0x95,
            0x20, 0x96, 0x14, 0xb7,
        ],
        // Root for tree with 5 leaves
        [
            0x4e, 0x3b, 0xbb, 0x1f, 0x7b, 0x47, 0x8d, 0xcf, 0xe7, 0x1f, 0xb6, 0x31, 0x63, 0x15,
            0x19, 0xa3, 0xbc, 0xa1, 0x2c, 0x9a, 0xef, 0xca, 0x16, 0x12, 0xbf, 0xce, 0x4c, 0x13,
            0xa8, 0x62, 0x64, 0xd4,
        ],
        // Root for tree with 6 leaves
        [
            0x76, 0xe6, 0x7d, 0xad, 0xbc, 0xdf, 0x1e, 0x10, 0xe1, 0xb7, 0x4d, 0xdc, 0x60, 0x8a,
            0xbd, 0x2f, 0x98, 0xdf, 0xb1, 0x6f, 0xbc, 0xe7, 0x52, 0x77, 0xb5, 0x23, 0x2a, 0x12,
            0x7f, 0x20, 0x87, 0xef,
        ],
        // Root for tree with 7 leaves
        [
            0xdd, 0xb8, 0x9b, 0xe4, 0x03, 0x80, 0x9e, 0x32, 0x57, 0x50, 0xd3, 0xd2, 0x63, 0xcd,
            0x78, 0x92, 0x9c, 0x29, 0x42, 0xb7, 0x94, 0x2a, 0x34, 0xb7, 0x7e, 0x12, 0x2c, 0x95,
            0x94, 0xa7, 0x4c, 0x8c,
        ],
        // Root for tree with 8 leaves
        [
            0x5d, 0xc9, 0xda, 0x79, 0xa7, 0x06, 0x59, 0xa9, 0xad, 0x55, 0x9c, 0xb7, 0x01, 0xde,
            0xd9, 0xa2, 0xab, 0x9d, 0x82, 0x3a, 0xad, 0x2f, 0x49, 0x60, 0xcf, 0xe3, 0x70, 0xef,
            0xf4, 0x60, 0x43, 0x28,
        ],
    ];
    ...
    fn test_verify_inclusion_with_test_vectors() {
        ...
        let proof = vec![
            ...
            vec![
                0x5f, 0x08, 0x3f, 0x0a, 0x1a, 0x33, 0xca, 0x07, 0x6a, 0x95, 0x27, 0x98, 0x32, 0x58,
                0x0d, 0xb3, 0xe0, 0xef, 0x45, 0x84, 0xbd, 0xff, 0x1f, 0x54, 0xc8, 0xa3, 0x60, 0xf5,
                0x0d, 0xe3, 0x03, 0x1e,
            ],
            vec![
                0x6b, 0x47, 0xaa, 0xf2, 0x9e, 0xe3, 0xc2, 0xaf, 0x9a, 0xf8, 0x89, 0xbc, 0x1f, 0xb9,
                0x25, 0x4d, 0xab, 0xd3, 0x11, 0x77, 0xf1, 0x62, 0x32, 0xdd, 0x6a, 0xab, 0x03, 0x5c,
                0xa3, 0x9b, 0xf6, 0xe4,
            ],
        ];
        ...
        let proof = vec![
            vec![
                0xbc, 0x1a, 0x06, 0x43, 0xb1, 0x2e, 0x4d, 0x2d, 0x7c, 0x77, 0x91, 0x8f, 0x44, 0xe0,
                0xf4, 0xf7, 0x9a, 0x83, 0x8b, 0x6c, 0xf9, 0xec, 0x5b, 0x5c, 0x28, 0x3e, 0x1f, 0x4d,
                0x88, 0x59, 0x9e, 0x6b,
            ],
            vec![
                0xca, 0x85, 0x4e, 0xa1, 0x28, 0xed, 0x05, 0x0b, 0x41, 0xb3, 0x5f, 0xfc, 0x1b, 0x87,
                0xb8, 0xeb, 0x2b, 0xde, 0x46, 0x1e, 0x9e, 0x3b, 0x55, 0x96, 0xec, 0xe6, 0xb9, 0xd5,
                0x97, 0x5a, 0x0a, 0xe0,
            ],
            vec![
                0xd3, 0x7e, 0xe4, 0x18, 0x97, 0x6d, 0xd9, 0x57, 0x53, 0xc1, 0xc7, 0x38, 0x62, 0xb9,
    ...
    fn test_verify_consistency_with_test_vectors() {
        ...
        let proof = vec![
            vec![
                0x0e, 0xbc, 0x5d, 0x34, 0x37, 0xfb, 0xe2, 0xdb, 0x15, 0x8b, 0x9f, 0x12, 0x6a, 0x1d,
                0x11, 0x8e, 0x30, 0x81, 0x81, 0x03, 0x1d, 0x0a, 0x94, 0x9f, 0x8d, 0xed, 0xed, 0xeb,
                0xc5, 0x58, 0xef, 0x6a,
            ],
            vec![
                0xca, 0x85, 0x4e, 0xa1, 0x28, 0xed, 0x05, 0x0b, 0x41, 0xb3, 0x5f, 0xfc, 0x1b, 0x87,
        ...
        let proof = vec![
            ...
            vec![
                0xb0, 0x86, 0x93, 0xec, 0x2e, 0x72, 0x15, 0x97, 0x13, 0x06, 0x41, 0xe8, 0x21, 0x1e,
                0x7e, 0xed, 0xcc, 0xb4, 0xc2, 0x64, 0x13, 0x96, 0x3e, 0xee, 0x6c, 0x1e, 0x2e, 0xd1,
                0x6f, 0xfb, 0x1a, 0x5f,
            ],
            vec![
                0xd3, 0x7e, 0xe4, 0x18, 0x97, 0x6d, 0xd9, 0x57, 0x53, 0xc1, 0xc7, 0x38, 0x62, 0xb9,
