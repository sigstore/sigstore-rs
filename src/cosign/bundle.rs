...
impl SignedArtifactBundle {
    ...
    pub fn new_verified(
        ...
        Bundle::verify_bundle(&bundle.rekor_bundle, rekor_pub_keys).map(|_| bundle)
    }
}
...
impl Bundle {
    ...
    pub(crate) fn new_verified(
        ...
        Self::verify_bundle(&bundle, rekor_pub_keys).map(|_| bundle)
    }
...
mod tests {
    ...
    fn bundle_new_verified_success() {
        ...
        let bundle = Bundle::new_verified(&bundle_json, &rekor_pub_keys);

        assert!(bundle.is_ok());
    }

    #[test]
    fn bundle_new_verified_failure_because_different_key_signed_the_bundle() {
...
-----END PUBLIC KEY-----"#;
        ...
        let rekor_pub_keys = BTreeMap::from([(key_id, not_rekor_pub_key)]);
    ...
    #[test]
    fn bundle_new_verified_failure_because_rekor_key_id_is_unknown() {
        let (_, key) = get_rekor_public_key();
        let key_id = "cf1199155bddd051268d1f16ac5c0c75c009f6fb5a63f4177f8e18d7051e3fa0".to_string();
        let rekor_pub_keys = BTreeMap::from([(key_id, key)]);
        ...
        assert!(matches!(
            bundle,
            Err(SigstoreError::RekorPublicKeyNotFoundError(_))
        ));
    }
...
{"base64Signature":"MEQCIGp1XZP5zaImosrBhDPCdXn3f8xI9FHGLsGVx6UeRPCgAiAt5GrsdQhOKnZcA3EWecvgJSHzCIjWifFBQkD7Hdsymg==","cert":"","rekorBundle":{"SignedEntryTimestamp":"MEUCIC3c+21v9pk6o4BpB/dRAM9lGnyWLi3Xnc+i8LmnNJmeAiEAiqZJbZHx3Idnw+zXv6yM0ipPw/p16R28YGuCJFQ1u8U=","Payload":{"body":"","integratedTime":1669361833,"logIndex":7810348,"logID":"c0d23d6ad406973f9559f3ba2d1ca01f84147d8ffc5b8445c224f98b9591801d"}}}
        ...
        let result = SignedArtifactBundle::new_verified(bundle_raw, &rekor_pub_keys);
        assert!(result.is_ok());
