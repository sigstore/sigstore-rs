...
use openidconnect::{
    AuthenticationFlow, AuthorizationCode, ClientId, ClientSecret, CsrfToken, IssuerUrl, Nonce, RedirectUrl, Scope, PkceCodeChallenge, PkceCodeVerifier
};
use url::Url;

pub fn auth_url(oidc_client_id: String, oidc_client_secret: String, oidc_issuer: String) -> (Url, CoreClient, Nonce, PkceCodeVerifier) {
...
pub fn redirect_listener(
    client: CoreClient,
    nonce: Nonce, pkce_verifier: PkceCodeVerifier) -> Result<CoreIdTokenClaims> {
